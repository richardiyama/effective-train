...
<div class="row">
    <div class="col-sm-8 offset-sm-2">
        <h1 class="display-3">Update Course File</h1>
        ...
        <br /> 
        @endif
        <form method="post" action="{{ route('coursefiles.update') }}" enctype="multipart/form-data">
        
            @csrf
            <div class="form-group">

                <label for="name">Page Name:</label>
                <input type="text" class="form-control" name="name" value={{ $coursefile->name }} />
            </div>
            <div class="form-group">
