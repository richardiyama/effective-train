...
<!-- Logo -->
<tr>
<td style="{{ $style['email-masthead'] }}"><a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank"> <img src="http://eaz-roc.ng/images/header/logo.jpg" height="150px"/>
<!--{{ config('app.name') }}-->
</a><br/><br/><div align="center"><h3>Contact Message From: {{$name}} with Email: {{$email}}</h3></div></td>
</tr>
<!-- Email Body -->
<tr>
<td style="{{ $style['email-body'] }}" width="100%"><table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td align="Left"> {{$bodymessage}} </td>
</tr>
</table></td>
</tr>
<!-- Footer -->
