...
<!--{{ config('app.name') }}-->
</a><br/><br/><div align="center"><h3>Background Check Schedule From: {{$fullname}}</h3></div>
...
</a><br/><br/><div align="center"><h3>What Background Check Services are you interested in?</h3></div>
<p align="center"> Safe Guard: {{$safeguard}} </p>
<p align="center"> Identity Verification: {{$identityverification}} </p>
<p align="center"> Address Verification: {{$addressverification}} </p>
<p align="center"> Guarantor Verification: {{$guarantorverification}} </p>
<p align="center"> Employment Verification: {{$employmentverification}} </p>
