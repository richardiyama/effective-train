...
<!--{{ config('app.name') }}-->
</a><br/><br/><div align="center"><h3>Business Logistics Schedule From: {{$fullname}}</h3></div>
...
</a><br/><br/><div align="center"><h3>What Business Logistics services are you interested in?</h3></div>
<p align="center"> Fleet Management: {{$fleetmanagement}} </p>
<p align="center"> Fleet Maintainance: {{$fleetmaintainance}} </p>
<p align="center"> Protocol Travel Ticketing: {{$protocoltravelticketing}} </p>
<p align="center"> Warehousing: {{$warehousing}} </p>
<p align="center"> Office Movies: {{$officemoves}} </p>
