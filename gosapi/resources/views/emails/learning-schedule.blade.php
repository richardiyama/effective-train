...
<!--{{ config('app.name') }}-->
</a><br/><br/><div align="center"><h3>Learning And Development Schedule From: {{$fullname}}</h3></div>
...
</a><br/><br/><div align="center"><h3>What Training Program are you interested in?</h3></div>
<p align="center"> Management Leadership: {{$mangementleadership}} </p>
<p align="center"> Exceptional Customer Service: {{$exceptionalcustomerservice}} </p>
<p align="center"> Performance Management: {{$performancemanagement}} </p>
<p align="center"> Basic Stress Management: {{$basicstressmanagement}} </p>
<p align="center"> Personal Effectiveness: {{$personaleffectiviness}} </p>
<p align="center"> Report Writting: {{$reportwritting}} </p>
<p align="center"> Team Building: {{$teambuilding}} </p>
<p align="center"> Presentation Skills For Managers: {{$presentationskillsformanagers}} </p>
<p align="center"> Effective Delegation For Managers: {{$effectivedelegationformanagers}} </p>
